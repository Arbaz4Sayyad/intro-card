  ...
  return (
    <section className="relative min-h-screen pt-16 pb-8 md:pt-24 md:pb-12 flex flex-col items-center justify-center text-center px-4">
      ...
      >
        ...
        >
          <a href="https://arbaz4sayyad.github.io/resume/" target="_blank" rel="noreferrer" className="flex items-center gap-2 px-6 py-3 rounded-full bg-zinc-100 text-zinc-950 font-semibold hover:bg-white hover:scale-105 hover:shadow-[0_0_20px_rgba(255,255,255,0.2)] transition-all duration-300">
